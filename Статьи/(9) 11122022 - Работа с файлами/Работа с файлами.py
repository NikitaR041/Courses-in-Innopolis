...
'''
##f = open('Записи.txt','w')
##f.write('Удали все')              # это команда перезаписи, как я считаю это достаточно не удобно, каждый раз создавать такую команду, что чтобы записать
##f.close()
##f = open('Записи.txt') 
##print(f.read())        
##f.close()              
...
'''
##import os
##os.system('Записи.txt') #Открывает блокнот!
'''
